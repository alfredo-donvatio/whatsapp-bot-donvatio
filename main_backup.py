...
Responde con el número de tu elección.""")
        ...
        try:
            ...
            estados[numero]["factura_bytes"] = base64.b64encode(pdf_bytes).decode()
            ...
            async with httpx.AsyncClient(timeout=60) as client:
                ...
                print(f"Contratación status: {response.status_code}")
                print(f"Contratación respuesta: {response.text}")
    ...
    f"¿Te interesa darte de alta en nuestra tarifa?Responde *SI* o *NO*."
        ...
        estados[numero]["paso"] = "pedir_numero_dni"
        enviar_mensaje(numero, instancia, "Por favor dime tu DNI.\n\nEjemplo: 65004204V")

    elif isinstance(estado_actual, dict) and estado_actual.get("paso") == "pedir_numero_dni":
        estados[numero]["numero_dni"] = mensaje
            ...
            try:
                ...
                async with httpx.AsyncClient(timeout=60) as client:
                    response = await client.post(
                        ...
                        headers={"Authorization": f"Bearer {token}"},
                        data={
                            "dni_titular": e["numero_dni"],
                            "nombre_titular": e["titular"],
                            "dni_firmante": e["numero_dni"],
